...
export default function TermsPage() {
    return (
        <>
            <Helmet>
                <title>Условия использования — Linkoo</title>
                <meta name="description"
                      content="Условия использования сервиса Linkoo — права и обязанности пользователей, правила работы с платформой."/>
                <link rel="canonical" href="https://linkoo.dev/terms"/>
                        ...
                        <div className="space-y-6 text-sm leading-relaxed">
                            ...
                            <section>
                                ...
                                <p className="text-muted-foreground">
                                    ...
                                    настоящие Условия. Если вы не согласны с Условиями, пожалуйста, не используйте
                                    Сервис.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4">
                                    ...
                                    <li>
                                        <strong>Free-аккаунт</strong> — бесплатная учетная запись с ограниченным
                                        функционалом
                                    </li>
                                    <li>
                                        <strong>Premium-аккаунт</strong> — платная учетная запись с расширенным
                                        функционалом
                                    </li>
                                </ul>
                            </section>
                            ...
                            <section>
                                ...
                                <p className="text-muted-foreground mb-2">
                                    3.2. Вы обязуетесь предоставлять достоверную и актуальную информацию при
                                    регистрации.
                                </p>
                                <p className="text-muted-foreground mb-2">
                            ...
                            <section>
                                ...
                                <p className="text-muted-foreground">
                                    5.5. Возврат осуществляется на тот же платежный инструмент, с которого была
                                    произведена оплата.
                                </p>
                            </section>
                            ...
                            <section>
                                ...
                                <ul className="list-disc list-inside space-y-1 text-muted-foreground ml-4">
                                    <li>Размещать незаконный, мошеннический, клеветнический или оскорбительный контент
                                    </li>
                            ...
                            <section>
                                <h2 className="text-xl font-semibold mb-3">10. Приостановление и прекращение
                                    доступа</h2>
                                <p className="text-muted-foreground mb-2">
                            ...
                            <section>
                                ...
                                <p className="text-muted-foreground">
                                    12.3. Претензионный порядок разрешения споров обязателен. Срок ответа на претензию —
                                    30 дней.
                                </p>
                            </section>
