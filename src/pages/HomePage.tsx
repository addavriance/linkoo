...
const HomePage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Linkoo — цифровые визитки</title>
                <meta name="description"
                      content="Создайте красивую цифровую визитку за пару минут. Делитесь контактами, соцсетями и портфолио по короткой ссылке вида linkoo.dev/yourname."/>
                <meta property="og:type" content="website"/>
                <meta property="og:title" content="Linkoo — цифровые визитки"/>
                <meta property="og:description"
                      content="Создайте красивую цифровую визитку за пару минут. Делитесь контактами, соцсетями и портфолио по короткой ссылке."/>
                <meta property="og:url" content="https://linkoo.dev"/>
                <meta name="twitter:card" content="summary"/>
                <meta name="twitter:title" content="Linkoo — цифровые визитки"/>
                <meta name="twitter:description" content="Создайте красивую цифровую визитку за пару минут."/>
                <link rel="canonical" href="https://linkoo.dev"/>
            </Helmet>
                ...
                <section className="relative px-6 pt-20 pb-16 text-center lg:px-8 lg:pt-32 lg:pb-24">
                    <div className="mx-auto max-w-4xl">
                        ...
                        <h1 className="mb-6 text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                            ...
                            <span
                                className="bg-gradient-to-r from-linkoo-600 to-accent-600 bg-clip-text text-transparent">визитки</span>
                            <svg
                        ...
                        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                            ...
                            >
                                Посмотреть темы
                                <Palette
                                    className="ml-2 h-5 w-5 transition-transform duration-200 group-hover:rotate-12"/>
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="mx-auto max-w-7xl">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                Мы создали самую современную платформу для цифровых визиток с фокусом на скорость и
                                удобство
                            </p>
                        </div>
