...
export const CardsCarousel: React.FC = () => {
    ...
    return (
        <div className="relative w-full overflow-hidden py-8 h-[60rem] sm:h-[74rem] lg:h-auto">
            ...
            {/* градиенты */}
            <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-muted to-transparent pointer-events-none z-10" />
            <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-muted to-transparent pointer-events-none z-10" />
        </div>
    );
};
